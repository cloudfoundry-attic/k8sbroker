...
func (fake *FakeK8sPersistentVolumes) Create(arg1 *v1.PersistentVolume) (*v1.PersistentVolume, error) {
...
func (fake *FakeK8sPersistentVolumes) Update(arg1 *v1.PersistentVolume) (*v1.PersistentVolume, error) {
...
var _ k8sbroker.K8sPersistentVolumes = new(FakeK8sPersistentVolumes)
